...
public class ImageService {
	...
	/**
	 * Upload the file to the file system, creates an Image entity for it and binds
	 * it to the Movie for the given movie id.
	 * 
	 ...
	 * @throws IOException exception is thrown if there is a problem writing the
